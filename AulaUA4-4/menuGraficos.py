...
while opcao != 0:
    ...
    match opcao:
        case 1: graficos.grafico_barra(l_moedas, l_valores)
        case 2: graficos.grafico_pizza(l_moedas, l_valores)
        case 3: graficos.grafico_dispersao(l_moedas, l_valores)
