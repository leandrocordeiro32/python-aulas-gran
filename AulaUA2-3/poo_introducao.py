...
# Criando um objeto "produto1" da classe "Produto"
produto1 = Produto(1, "Camisa", 10)

# Chamando o método "mostrar_detalhes" do objeto "produto1"
produto1.mostrar_detalhes()

# Adicionando estoque ao objeto "produto1"
produto1.adicionar_estoque(5)

# Chamando o método "mostrar_detalhes" novamente para verificar a quantidade atualizada
produto1.mostrar_detalhes()